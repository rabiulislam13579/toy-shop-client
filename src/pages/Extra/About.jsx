...
const About = () => {
    return (
        <div className='lg:flex  sm:w-full my-16 items-center p-12'>
            <div className='lg:w-1/2 me-3'>
                <h2 className='text-3xl text-purple-900 font-bold'>About Us</h2>
                <p className=''>Welcome to the virtual wonderland of our toy shop website! As you enter our online realm, you'll be immersed in a captivating world of toys and imagination, all just a click away.
            ...
            <div className='lg:w-1/2'>
                <img className='rounded w-[400 px]' src="https://media.istockphoto.com/id/1185943155/photo/beautiful-toddler-sitting-on-the-floor-playing-with-building-blocks-toys-at-kindergarten.jpg?s=612x612&w=0&k=20&c=FJreI34oJhGcdVhnALb-58Ys0ySay61Jnr1WOPgR_bM=" alt="" />
            </div>
        </div>
    );
};
